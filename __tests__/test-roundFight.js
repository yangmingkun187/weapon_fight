...
//jest.dontMock('../src/model/fight');
//jest.dontMock('../src/model/armor');
//jest.dontMock('../src/model/state');
...
describe('fight', function() {
    describe('roundFight', function() {
        it('should return correct text', function() {
            ...
            expect(text).toBe( '战士张三用毒剑攻击了普通人李四,李四受到了215点伤害,李四中毒了,李四剩余生命:785\n' +
            '李四受到2点毒性伤害,李四剩余生命:783\n' +
            '普通人李四攻击了战士张三,攻击了200点伤害,张三的阿克斯圣光盾抵挡了7点伤害,张三还剩807点血\n');
        });
    });
});
